export interface SurahInfoBasic {
  number: number;
  name: string; // Arabic name
  englishName: string; // English name
  revelationType: 'Meccan' | 'Medinan'; // Revelation type
  numberOfAyahs: number; // Number of Ayahs
}

// List of all 114 Surahs with added details
export const surahList: SurahInfoBasic[] = [
  ...
  { number: 3, name: 'آل عمران', englishName: 'Aal-i-Imran', revelationType: 'Medinan', numberOfAyahs: 200 },
  { number: 4, name: 'النساء', englishName: 'An-Nisa', revelationType: 'Medinan', numberOfAyahs: 176 },
  { number: 5, name: 'المائدة', englishName: 'Al-Ma\'ida', revelationType: 'Medinan', numberOfAyahs: 120 },
  ...
  { number: 56, name: 'الواقعة', englishName: 'Al-Waqi\'a', revelationType: 'Meccan', numberOfAyahs: 96 },
  ...
  { number: 75, name: 'القيامة', englishName: 'Al-Qiyama', revelationType: 'Meccan', numberOfAyahs: 40 },
  ...
  { number: 88, name: 'الغاشية', englishName: 'Al-Ghashiya', revelationType: 'Meccan', numberOfAyahs: 26 },
  ...
  { number: 101, name: 'القارعة', englishName: 'Al-Qari\'a', revelationType: 'Meccan', numberOfAyahs: 11 },
